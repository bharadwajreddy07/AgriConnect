...
const cropTemplates = [
    ...
    { name: 'Maize', category: 'Cereals', season: 'Kharif', priceRange: [1500, 2200], unit: 'quintal', image: 'https://images.unsplash.com/photo-1551754655-cd27e38d2076?w=800&q=80' },
    ...
    { name: 'Cotton', category: 'Cash Crops', season: 'Kharif', priceRange: [4500, 6000], unit: 'quintal', image: 'https://images.unsplash.com/photo-1609706857965-7d2c0b8b5b0f?w=800&q=80' },
...
async function seedCropsOnly() {
    try {
        ...
        if (farmers.length === 0) {
            ...
            console.log('   You can register farmers through the UI or run seedDatabase.js');
            process.exit(1);
        }
        ...
        for (let i = 0; i < 400; i++) {
            ...
            const crop = {
                ...
                consumerPrice: getRandomPrice(template.priceRange) * 1.2, // 20% markup for consumers
        ...
        console.log('💡 Consumers can now browse and purchase these products!');
