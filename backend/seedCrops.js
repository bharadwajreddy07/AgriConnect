...
const cropTemplates = [
    ...
    { name: 'Tobacco', category: 'Cash Crops', season: 'Rabi', priceRange: [8000, 12000], unit: 'quintal', image: 'https://images.unsplash.com/photo-1601985705806-5b9a71f6004f?w=800&q=80' },
    ...
    { name: 'Black Pepper', category: 'Spices', season: 'Year-Round', priceRange: [40000, 50000], unit: 'quintal', image: 'https://images.unsplash.com/photo-1599909533730-f9d7e4c2f5b5?w=800&q=80' },
    { name: 'Cardamom', category: 'Spices', season: 'Year-Round', priceRange: [100000, 150000], unit: 'quintal', image: 'https://images.unsplash.com/photo-1596040033229-a0b3b83b6aec?w=800&q=80' },
...
const indianStates = [
    ...
    'Tamil Nadu', 'Andhra Pradesh', 'Telangana', 'Kerala', 'Assam'
];

const districts = {
    'Punjab': ['Ludhiana', 'Amritsar', 'Jalandhar', 'Patiala', 'Bathinda'],
    'Haryana': ['Karnal', 'Hisar', 'Rohtak', 'Panipat', 'Ambala'],
    'Uttar Pradesh': ['Meerut', 'Agra', 'Lucknow', 'Kanpur', 'Varanasi'],
    'Bihar': ['Patna', 'Gaya', 'Bhagalpur', 'Muzaffarpur', 'Darbhanga'],
    'West Bengal': ['Kolkata', 'Howrah', 'Darjeeling', 'Bardhaman', 'Murshidabad'],
...
async function seedCrops() {
    try {
        ...
        if (farmers.length === 0) {
            console.log('⚠️  No farmers found. Please create farmer accounts first.');
            process.exit(1);
        }
